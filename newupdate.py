...
while True:
    ...
    if capture_lip_shape:
        ...
        for face in faces:
            ...
            reference_points = [(100, 100) for _ in range(len(lip_points))]  # Example reference points
            hausdorff_distance = directed_hausdorff(np.array(lip_points), np.array(reference_points))[0]

            # Save mean, variance, and Hausdorff distance to a text file
            ...
            with open(stats_file_path, 'w') as stats_file:
                ...
                stats_file.write(f"Hausdorff Distance: {hausdorff_distance}\n")
